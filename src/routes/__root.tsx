...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover great apps, games, and AI tools on Nova App Store." },
      { name: "application-name", content: "Nova App Store" },
      { property: "og:title", content: "Nova App Store" },
      { property: "og:description", content: "Discover great apps, games, and AI tools on Nova." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Nova App Store" },
      { name: "twitter:description", content: "Discover great apps, games, and AI tools on Nova." },
