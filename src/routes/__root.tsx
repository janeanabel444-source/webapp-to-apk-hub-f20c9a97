...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover great apps, games, and AI tools on Niza App Store." },
      { name: "application-name", content: "Niza App Store" },
      { property: "og:title", content: "Niza App Store" },
      { property: "og:description", content: "Discover great apps, games, and AI tools on Niza." },
